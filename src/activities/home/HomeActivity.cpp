...
int HomeActivity::getMenuItemCount() const {
  int count = 6;  // File Browser, Recents, Games, Stats, File transfer, Settings
...
void HomeActivity::render(RenderLock&&) {
  ...
  std::vector<UIIcon> menuIcons = {Folder, Recent, Games, Stats, Transfer, Settings};
...
void HomeActivity::onGamesOpen() { activityManager.goToFileBrowser("/games"); }

void HomeActivity::onStatsOpen() {
  // TODO: Build a dedicated StatsActivity with storage info + reading stats
  // For now, show a full-screen message
  activityManager.goToFullScreenMessage("Stats — Coming Soon");
}
